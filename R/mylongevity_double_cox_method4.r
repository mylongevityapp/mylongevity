...
#'    - sex: indicator for gender (1 - Male , 2 - Female)
...
#'    - asthma: indicator for asthma (0 - absence of asthma, 1 - presence of asthma)
#'    - COPD: indicator for chronic obstructive pulmonary disease (0 - absence of chronic obstructive pulmonary disease, 1 - presence of chronic obstructive pulmonary disease)
#'    - CKD: indicator for chronic kidney disease (0 - absence of chronic kidney disease , 1 - presence of chronic kidney disease)
#'    - myocardial_infarction:  indicator for myocardial infarction (0 - absence of myocardial infarction, 1 - presence of myocardial infarction)
#'    - PVD_PAD: indicator for peripheral vascular disease (0 - absence of peripheral vascular disease, 1 - presence of peripheral vascular disease)
...
#'    - atrial_fibrillation: indicator for atrial fibrillation  (0 - absence of atrial fibrillation, 1 - presence of atrial fibrillation)
#'    - Diabetes_factor: indicator for diabetes (0 - absence of diabetes, 1 - presence of diabetes and treated, 2 - absence of diabetes and untreated)
